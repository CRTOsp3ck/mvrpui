                ...
                <VCard>
                    <VCardText>
                        <div class="d-flex justify-space-between align-center">
                            ...
                            <VAvatar size="42" variant="tonal" :color="data.color">
                    ...
                    <VCardText>
                        <div class="d-flex flex-column flex-sm-row gap-6 justify-sm-space-between align-center pt-2">
                            <div v-for="(step, index) in stepsData" :key="index"
                                class="d-flex flex-column align-center gap-y-2" style="max-inline-size: 185px;">
                    ...
                    <VCardText>
                        <div class="mb-8">
                            ...
                            <div class="d-flex align-center flex-wrap gap-4 flex-wrap">
                                <AppTextField label="Enter friend’s email address and invite them"
                                    placeholder="Email Addresss" density="compact" />
                        ...
                        <div>
                            ...
                            <div class="d-flex gap-4 align-center flex-wrap">
                                <AppTextField label="Share referral link in social media"
                                    placeholder="pixinvent.com/?ref=6478" density="compact" />
                    ...
                    <VCardText>
                        <div class="d-flex justify-space-between align-center flex-wrap gap-4">
                            ...
                            <div class="d-flex flex-wrap gap-4">
                                <div class="d-flex gap-4 align-center flex-wrap">
                                    <VSelect v-model="itemsPerPage" :items="[10, 25, 50, 100]"
                                        style="inline-size: 100px;" density="compact" />
                                    <VBtn prepend-icon="tabler-screen-share" color="default" variant="tonal">
                                        Export
                                    </VBtn>
                                </div>
                            </div>
                    ...
                    <VDataTableServer v-model:items-per-page="itemsPerPage" v-model:page="page" :items="referrals"
                        ...
                        <template #item.users="{ item }">
                            <div class="d-flex align-center gap-x-3">
                                <VAvatar :image="item.avatar" :size="38" />
                                <div>
                        ...
                        <template #bottom>
                            ...
                            <div
                                ...
                                <VPagination v-model="page" :length="Math.ceil(totalReferrals / itemsPerPage)"
