    ...
    <div>
        <VCard>
            <VCardText>
                <div class="d-flex justify-sm-space-between flex-wrap gap-y-4 gap-x-6 justify-start">
                    ...
                    <div class="d-flex align-center flex-wrap gap-4">
                        ...
                        <VBtn prepend-icon="tabler-plus" @click="isAddProductDrawerOpen = !isAddProductDrawerOpen">
                            Add Category
                        </VBtn>
                    </div>
                </div>
            ...
            <div class="category-table">
                <VDataTable v-model:items-per-page="itemsPerPage" v-model:page="page" :headers="headers"
                    :items="categoryData" item-value="categoryTitle" :search="searchQuery" show-select
                    class="text-no-wrap">
                    ...
                    <template #bottom>
                        ...
                        <div class="d-flex align-center justify-space-between flex-wrap gap-3 pa-5 pt-3">
                            <p class="text-sm text-medium-emphasis mb-0">
                                ...
                                {{ Math.min(itemsPerPage * page, categoryData.length) }} of {{ categoryData.length }}
                                entries
                            </p>
                            <VPagination v-model="page" :length="Math.ceil(categoryData.length / itemsPerPage)"
                                :total-visible="5">
