...
const product = ref<SchemaItemItem>(new SchemaItemItemClass('product'))

const paramId = computed(() => parseInt(route.params.id))

if (paramId.value > 0) {
  const resp = await getItemViewService(paramId.value)
  const data: any = resp.data
  if (data && data.payload) {
    product.value = data.payload
...
const createProduct = async () => {
  ...
  if (resp.status === 200 || resp.status === 201) {
    const redirectTo = '/product/product/view/' + product.value.id
    await navigateTo({ path: redirectTo })
  }
}

const updateProduct = async () => {
  console.log("Trying to update product", product.value)
  const resp = await updateItemService(product.value)
  ...
  <div>
    <div class="d-flex flex-wrap justify-start justify-sm-space-between gap-y-4 gap-x-6 mb-6">
      <div class="d-flex flex-col gap-x-4">
        <IconBtn :to="{ name: 'product-product-list' }">
            <VIcon icon="tabler-chevron-left" />
        </IconBtn>
        <div class="d-flex flex-column justify-center">
          <h4 class="text-h4 font-weight-medium">
            Create / Update a product item
          </h4>
      ...
      <div class="d-flex gap-4 align-center flex-wrap">
        <VBtn :to="{ name: 'product-product-list' }"
        ...
        <VBtn v-if="paramId>0" @click="updateProduct">
            Update Product
        </VBtn>
        <VBtn v-else @click="createProduct">
            Create Product
        </VBtn>
      </div>
    </div>
    ...
    <VRow>
        ...
        >
          <VCardText>
            <VRow>
              ...
              <VCol cols="12">
                <AppTextField v-model="product.name" :rules="[requiredValidator]" label="Name" placeholder="iPhone 14"/>
              </VCol>

              <VCol cols="12" md="6">
                <AppTextField v-model="product.sku" :rules="[requiredValidator]" label="SKU" placeholder="FXSK123U"/>
              </VCol>
              ...
              <VCol>
                ...
                <TiptapEditor v-model="product.description" placeholder="Product Description" class="border rounded"/>
              </VCol>
      ...
      >
        ...
        <VCard 
          ...
          <VCardText>
            <div class="d-flex flex-column gap-y-4">
              <AppTextField
                v-model="product.brand" :rules="[requiredValidator]"
                label="Brand"
              ...
              <div>
                ...
                <AppSelect
                  ...
                  v-model="product.category" :rules="[requiredValidator]"
              ...
              <AppSelect
                ...
                label="Origin"
                v-model="product.origin" :rules="[requiredValidator]"
              ...
              <AppSelect
                ...
                label="Status"
                v-model="product.status" :rules="[requiredValidator]"
        ...
        >
          <VCardText>
            <AppTextField
              v-model="product.price" :rules="[requiredValidator]"
              label="Best Price"
              placeholder="Price"
              class="mb-6"
            />
            ...
            Final Price: <b>${{ product.price?.toFixed(2) }}</b>
            </p>
        ...
        >
          <VCardText>
            <AppTextField
              label="Base Cost"
              v-model="product.cost" :rules="[requiredValidator]"
              placeholder="Cost"
              class="mb-6"
            />
            <AppTextField
