...
const route = useRoute('product-service-create-or-update-id')
...
// const product = ref<SchemaItemItemClass>(new SchemaItemItemClass('product'))
const service = ref<SchemaItemItem>(new SchemaItemItemClass('service'))

if (route.params.id > 0) {
  const resp = await getItemViewService(route.params.id)
  if (resp.data && resp.data.payload) {
    service.value = resp.data.payload
  } else {
    showMultiLineMessage(resp);
  }
}

const createProduct = async () => {
    const resp = await createItemService(service.value)
...
const updateProduct = async () => {
    const resp = await updateItemService(service.value)
    if (resp.message || resp.error) {
        showMultiLineMessage(resp.message || resp.error);
    }
    ...
    if (resp.status === 200 || resp.status === 201) {
        // go to view service page
        const redirectTo = '/product/service/view/' + service.value.id
  ...
  <div>
    <div class="d-flex flex-wrap justify-start justify-sm-space-between gap-y-4 gap-x-6 mb-6">
      <div class="d-flex flex-col gap-x-4">
        <IconBtn :to="{ name: 'product-service-list' }">
            <VIcon icon="tabler-chevron-left" />
        </IconBtn>
        <div class="d-flex flex-column justify-center">
          <h4 class="text-h4 font-weight-medium">
            Create / Update a service item
          </h4>
    ...
    <VRow>
        ...
        >
          <VCardText>
            <VRow>
              ...
              <VCol cols="12">
                <AppTextField v-model="service.name" :rules="[requiredValidator]" label="Name" placeholder="iPhone 14"/>
              </VCol>

              <VCol cols="12" md="6">
                <AppTextField v-model="service.sku" :rules="[requiredValidator]" label="SKU" placeholder="FXSK123U"/>
              </VCol>
              ...
              <VCol>
                ...
                <TiptapEditor v-model="service.description" placeholder="Product Description" class="border rounded"/>
              </VCol>
      ...
      >
        ...
        <VCard 
          ...
          <VCardText>
            <div class="d-flex flex-column gap-y-4">
              <!-- <AppTextField
                v-model="service.brand" :rules="[requiredValidator]"
                label="Provider"
              ...
              <div>
                <VLabel class="d-flex">
                  <div class="d-flex text-sm justify-space-between w-100">
                    ...
                    <div class="text-primary cursor-pointer mb-1">
                      Add new category
                    </div>
                  </div>
                </VLabel>
                ...
                <AppSelect
                  ...
                  v-model="service.category" :rules="[requiredValidator]"
              ...
              <!-- <AppSelect
                ...
                label="Origin"
                v-model="service.origin" :rules="[requiredValidator]"
              ...
              <AppSelect
                ...
                label="Status"
                v-model="service.status" :rules="[requiredValidator]"
        ...
        >
          <VCardText>
            <AppTextField
              v-model="service.price" :rules="[requiredValidator]"
              label="Best Price"
              placeholder="Price"
              class="mb-6"
            />
            ...
            Final Price: <b>${{ parseFloat(service.price).toFixed(2) }}</b>
            </p>
        ...
        >
          <VCardText>
            <AppTextField
              label="Base Cost"
              v-model="service.cost" :rules="[requiredValidator]"
              placeholder="Cost"
              class="mb-6"
            />
            <AppTextField
