    ...
    <VCard>
        <VRow no-gutters>
            <VCol cols="12" md="4" lg="3" :class="$vuetify.display.mdAndUp ? 'border-e' : 'border-b'">
                <VCardText>
                    <AppStepper v-model:current-step="currentStep" direction="vertical" :items="createDealSteps"
            ...
            <VCol cols="12" md="8" lg="9">
                <VCardText>
                    ...
                    <div class="d-flex flex-wrap gap-4 justify-sm-space-between justify-center mt-8">
                        ...
                        <VBtn v-if="createDealSteps.length - 1 === currentStep" color="success"
                            append-icon="tabler-check" @click="onSubmit">
                            submit
                        </VBtn>
