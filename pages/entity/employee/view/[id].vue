...
const route = useRoute('entity-employee-view-id')
...
if (data && data.payload) {
  ...
  const msg = data.message || data.error
    showMultiLineMessage(msg || 'An error occured whiile trying to send the request');
}

const pageTitle = computed(() => {
  return "View Employee #" + entity.value?.id
})
