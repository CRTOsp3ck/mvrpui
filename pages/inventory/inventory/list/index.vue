...
const datasource : IServerSideDatasource = {
  getRows(params) {
    ...
    searchInventoryViewsService(req)
    .then((resp) => {
...
<template>
  <div>
    <PageTitle title="Inventory List Management" description="List of all inventories" />
    ...
    <VCard class="mb-6">
      <div class="d-flex align-center justify-between flex-wrap gap-4 mx-6 my-6">
        <!-- 👉 Create button -->
        <VBtn :to="{ name: 'inventory-inventory-create-or-update-id', params: { id: '-1' } }" prepend-icon="tabler-plus">
            Create
        </VBtn>
        <!-- 👉 Export button -->
