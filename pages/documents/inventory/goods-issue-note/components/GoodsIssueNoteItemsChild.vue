...
import type { SchemaInventoryGoodsIssueNoteItem } from '@/composables/schema';
...
interface Props {
  id: number
  data: SchemaInventoryGoodsIssueNoteItem
}
...
watch(selectedInventory, () => {
  ...
  props.data.unit_value = selectedInventory.value?.price_per_unit
}, { immediate: true })
...
const totalPrice = computed(() => Number(props.data.unit_value) * Number(props.data.quantity))
