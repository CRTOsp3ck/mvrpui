...
import SalesInvoiceInfoCard from '../components/SalesInvoiceInfoCard.vue'
import CustomerRenderer from '@/pages/documents/sales/components/CustomerRenderer.vue'
import SalesInvoiceNumberRenderer from '../components/SalesInvoiceNumberRenderer.vue'
import SalesInvoicePaymentStatusRenderer from '../components/SalesInvoicePaymentStatusRenderer.vue';
...
const colDefs = ref([
  ...
  { 
    ...
    enableRowGroup: true, 
    flex: 1, 
    cellRenderer: SalesInvoiceNumberRenderer,
  },
  { 
  ...
  { 
    field: "invoice_items.length", 
    headerName:"Quantity", 
    enableRowGroup: true,  
    enableValue: true, 
    flex: 1,
    valueGetter: (params: any) => { return params.data.invoice_items.length + " Items(s)"; },
  },
  { 
  ...
  { 
    field: "base_document.payment_status", 
    headerName:"Payment Status",
    enableRowGroup: true, 
    flex: 1, 
    cellRenderer: SalesInvoicePaymentStatusRenderer,
  },
  { 
    field: "base_document.issue_date", 
...
<template>
  <div>
    <PageTitle 
      title="Sales Invoice (INVs) Management" 
      description="View all sales invoices created over the course of selected period." 
    />
  
    <SalesInvoiceInfoCard />
    ...
    <VCard class="mb-6">
      <div class="d-flex align-center justify-between flex-wrap gap-4 mx-6 my-6">
        <!-- 👉 Create button -->
        <VBtn :to="{ name: 'documents-sales-sales-invoice-create-or-update-id', params: { id: '-1' } }" prepend-icon="tabler-plus">
            Create
        </VBtn>
        <!-- 👉 Export button -->
