...
import SalesOrderInfoCard from '../components/SalesOrderInfoCard.vue'
import CustomerRenderer from '@/pages/documents/sales/components/CustomerRenderer.vue'
import SalesOrderNumberRenderer from '../components/SalesOrderNumberRenderer.vue'
import OrderStatusRenderer from '../components/OrderStatusRenderer.vue';
...
<template>
  <div>
    <PageTitle 
      title="Sales Orders (SOs) Management" 
      description="View all sales orders created over the course of selected period." 
    />
